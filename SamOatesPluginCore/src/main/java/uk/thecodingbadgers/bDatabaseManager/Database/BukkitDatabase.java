...
public abstract class BukkitDatabase {
     ...
     * @param instant	Should the command be processed instantly, or be executed
     ...
     * @param name
     * @param layout
     * @return A new database table, or the table should it already exist.
     * Should creation fail, null is returned.
     */
